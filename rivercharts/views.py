    ...
    'value': {
        'timeSeries': [{
            'values': [{
                ...
                } for i in range(3000)]  # 2000 or however many entries you want
            }]
        }]
    }
}
...
def river_graph_data(request):
    ...
    for _, row in FLOAT_DATA.iterrows():
        ...
        color = "red" if floated_status == "N" else "green"
    ...
    return JsonResponse({'graph_div': graph_div, 'station_name': config_station_name})
